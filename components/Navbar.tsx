  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#DAD8D2] bg-[#F9F8F6]/95 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href={localizedPath(lang, '/')} className="group flex items-center gap-3"><strong className="block text-lg leading-none tracking-tight text-[#102A20]">Artlantix</strong></Link>
