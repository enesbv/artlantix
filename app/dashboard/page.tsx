  ...
  return (
    <div className="space-y-8">
      ...
      {previewReadyOrders.length > 0 && (
        <div className="rounded-xl border-2 border-[#E25C34] bg-[#FAF0EC] p-5 shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="rounded-full bg-[#E25C34] p-1.5 text-white mt-0.5">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded bg-[#E25C34] px-4 py-2 text-xs font-bold text-white hover:bg-[#D94A26] transition-colors whitespace-nowrap"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-xl border border-[#E6E4DF] bg-white p-5 shadow-xs">
          <div className="flex items-center justify-between text-xs text-[#666666]">
            ...
            <Clock className="h-4 w-4 text-[#E25C34]" />
          </div>
      ...
      <div className="rounded-xl border border-[#E6E4DF] bg-white shadow-xs overflow-hidden">
        <div className="flex items-center justify-between border-b border-[#E6E4DF] px-6 py-4">
          ...
          <Link
            ...
            className="text-xs font-semibold text-[#E25C34] hover:underline"
          >
                  ...
                  <tr key={order.id} className="hover:bg-[#FAFAF8] transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 font-semibold text-[#E25C34] hover:underline"
                      >
