...
export const marketingCopy = {
  tr: {
    home: {
      ...
      titleLines: ['Pikselden.', 'Vektöre.', 'Üretime.'],
    ...
    pages: {
      servicesEyebrow: 'Hizmet kataloğu', servicesTitle: 'Tek bir görselden üretim sistemine.', servicesBody: 'Logo temizliğinden CNC kesim konturuna kadar her hizmet net kapsam, süre ve teslimatlarla sunulur.',
      workEyebrow: 'Yöntem ve sonuç', workTitle: 'Önce / sonra değil; problem / çözüm / üretim sonucu.', workBody: 'Bu demonstrasyonlar vaka çalışması altyapısını gösterir. Doğrulanmış müşteri işleri yalnız yayın izniyle eklenecektir.',
      pricingEyebrow: 'Teklif modeli', pricingTitle: 'Şeffaf başlangıç fiyatları. Sürpriz fatura yok.', pricingBody: 'Gösterilen fiyat bir başlangıç tahminidir. Üretim yalnız dosya incelemesi ve nihai fiyat onayından sonra başlar.',
      guidesEyebrow: 'Bilgi merkezi', guidesTitle: 'Daha iyi dosya, daha sorunsuz üretim.', guidesBody: 'Vektör, baskı, kesim ve nakış kararlarını sade biçimde anlatan özgün stüdyo rehberleri.',
      faqEyebrow: 'Yardım merkezi', faqTitle: 'Teklif, üretim ve teslim hakkında net cevaplar.', faqBody: 'Cevabınızı bulamazsanız uzman değerlendirmesi seçerek dosyanızı doğrudan stüdyoya gönderin.',
    },
  },
  en: {
    home: {
      eyebrow: 'Manual vector production studio', titleLines: ['From pixel.', 'To vector.', 'To production.'], description: 'We turn AI concepts, blurry logos and legacy scans into clean vector masters for print, embroidery, signage and CNC.', primary: 'Upload your file', secondary: 'See before / after', proofEyebrow: 'Verifiable studio standard', proofTitle: 'Visible production discipline, not empty promises.', servicesEyebrow: 'Services', servicesTitle: 'Built around where your file goes next.', servicesBody: 'Every service clearly explains scope, starting price, turnaround and deliverables.', allServices: 'View all services', processEyebrow: 'Process', processTitle: 'Four clear steps. One private workspace.', workEyebrow: 'Working method', workTitle: 'See the problem, approach and production outcome together.', workBody: 'Until client publication permission exists, examples are clearly marked as studio demonstrations.', allWork: 'View all work', pricingEyebrow: 'Transparent pricing', pricingTitle: 'Know the starting price and approve the final quote before production.', pricingBody: 'No card is charged. We review your file and present the final scope and price for approval.', fullPricing: 'Explore pricing', guidesEyebrow: 'Studio guides', guidesTitle: 'Short guides for understanding production artwork.', allGuides: 'All guides', faqEyebrow: 'Common questions', faqTitle: 'What to know before you begin.', finalTitle: 'Let’s find out whether your file is production-ready.', finalBody: 'Upload privately. If you choose expert assessment, the studio will determine complexity and price.',
    },
  ...
  de: {
    ...
    pages: { servicesEyebrow: 'Leistungskatalog', servicesTitle: 'Von einem Bild zum Produktionssystem.', servicesBody: 'Von Logo-Bereinigung bis CNC-Schneidkontur: jede Leistung mit klarem Umfang, Zeitplan und Dateien.', workEyebrow: 'Methode und Ergebnis', workTitle: 'Nicht nur vorher / nachher: Problem / Lösung / Produktionsergebnis.', workBody: 'Diese Demonstrationen zeigen das Fallstudien-System. Verifizierte Kundenarbeiten erscheinen nur mit Freigabe.', pricingEyebrow: 'Angebotsmodell', pricingTitle: 'Transparente Startpreise. Keine überraschenden Rechnungen.', pricingBody: 'Der Preis ist eine Startschätzung. Produktion beginnt erst nach Dateiprüfung und Freigabe des Endangebots.', guidesEyebrow: 'Wissensbereich', guidesTitle: 'Bessere Dateien, reibungslosere Produktion.', guidesBody: 'Eigene Studio-Ratgeber erklären Vektor, Druck, Schnitt und Stickerei verständlich.', faqEyebrow: 'Hilfe', faqTitle: 'Klare Antworten zu Angebot, Produktion und Lieferung.', faqBody: 'Wenn Ihre Frage offen bleibt, wählen Sie die Expertenprüfung und senden Sie Ihre Datei direkt ans Studio.' },
  },
} as const;
